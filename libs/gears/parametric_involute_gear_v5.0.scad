...
module gear (
	...
	involute_facets=0)
{
	if (circular_pitch==false && diametral_pitch==false && pcd == false) 
		echo("MCAD ERROR: gear module needs either a diametral_pitch or circular_pitch or pcd");
	pitch_diameter = pcd;
	nteeth = pcd / gear_mod;
/*	echo ("PCD:", pcd, "Mod:", gear_mod, "Teeth:", nteeth, " Pitch diameter:", pitch_diameter);
	if ( pcd != false) {
	   pitch_diameter = pcd;
	   nteeth = pcd / gear_mod;
	   echo ("PCD:", pcd, "Mod:", gear_mod, "Teeth:", nteeth, " Pitch diameter:", pitch_diameter);
		...
		pitch_diameter  =  nteeth * circular_pitch / 180;
		echo ("Teeth:", nteeth, " Pitch radius:", pitch_radius);
	}*/
	...
	// Addendum: Radial distance from pitch circle to outside circle.
	addendum = tooth_multiple/pitch_diametrial;
	...
	half_thick_angle = (360 / nteeth - backlash_angle) / 4;
